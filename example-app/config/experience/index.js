const experience = {
  patterns: [
    {
      id: "exp1",
      label: "Pattern default Fossi Livorno",
      spots: [
        {
          id: "s0a",
          label: "Darsena Nuova",
