...
import GeoXpWebAudio from 'web-audio';
import GeoXpWebGeolocation from 'web-geolocation';
import GeoXpWebStorage from 'web-storage';
...
window.onload = () => {
  ...
  geoXpCore = new GeoXpCore(config.core);
